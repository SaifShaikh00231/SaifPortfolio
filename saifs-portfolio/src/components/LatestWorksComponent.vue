    ...
    <section class="-mt-2 bg-black">
      ...
      >
        ...
        >
          ...
          >
            <img
              ...
              src="../assets/images/nirdhara.png"
              alt=""
            />
            <span
        ...
        <div class="w-full">
          <h3 class="text-[#459bd5] font-bold text-2xl md:text-4xl">
            Nirdhara Fresh Juicery
          </h3>
          <span class="text-[#459bd5] text-base md:text-lg"
            >(Ecommerce Website)</span
          >
          <p class="mt-2 text-sm text-justify md:text-base">
            Nirdhara is an eCommerce platform designed for our client to sell fresh juices, featuring a seamless subscription model for recurring orders.
          </p>
      ...
      >
        <div class="order-2 w-full sm:order-1">
          ...
          >
          <p class="mt-2 text-sm text-justify md:text-base">
            EasyMyTasks is a workflow management platform designed for CAs to streamline their operations. 
            It allows task assignment, employee tracking, and efficient service management.
          </p>
      ...
      >
        ...
        <div class="w-full">
          ...
          >
          <p class="mt-2 text-sm text-justify md:text-base">
            VMS is a role-based access system for adding, viewing, and recording live camera feeds. 
            Built the entire platform from scratch for private client, ensuring secure and efficient access control.
          </p>
